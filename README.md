...
| "El Puente"  | Created a dashboard for Consulting Firms where their corporate clients can chat with Gemini and search through a vector database of developers that might fit best their project requirements. Built for Build with AI Hackathon.                                | <ul><li>Python + FastAPI to build the API.</li><li>Next.js for dashboard.</li><li>GeminiAPI for chatbot and embeddings.</li><li>Qdrant as vector database to store developers information, which can be later easily retrieved using Gemini (RAG).</li> </ul> | [gdg-ai](https://github.com/brauliorivas/gdg-ai/)             |
